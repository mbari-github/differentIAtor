...
@customElement('oggi-view')
export class OggiView extends LitElement {
  connectedCallback() {
      ...
      <main class="max-w-screen-lg mx-auto pb-l px-l">
        <vaadin-horizontal-layout class="items-center justify-between">
          <vaadin-vertical-layout>
            <h2 class="mb-0 mt-xl text-3xl">Ricerche correlate</h2>
            <p class="mb-xl mt-0 text-secondary">Alcune ricerche che potrebbero interessarti</p>
          </vaadin-vertical-layout>
